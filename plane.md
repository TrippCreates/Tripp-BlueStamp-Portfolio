# Foam RC Airplane
Another project of mine is a Foam RC Airplane that I built from scratch. The biggest challenge of this project came when trying to make the plane balance and easily flayble. I knew almost nothing about aerodynamics, and really any physics overall, going into this, but that made the experience that much better because I got to learn so much from it. The biggest takeaway is that integration is really hard. I easily put together the electronics, and then in turn the hardware which was really just a foam plane design I made up, but integrating the two, and getting them to work well together took literal months, where every night I was attempting to get the two opposing forces to come together in harmony
